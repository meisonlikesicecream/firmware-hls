...
// 16 bits 	 2^(0)Kphi^(1)	7.71867e-06
...
// 18 bits 	 2^(14)Kphi^(2)Kr^(0)	9.76124e-07
...
const ap_int<35> a2b_tmp = (a2a * 67078);
...
// 18 bits 	 2^(-11)Kphi^(1)Kr^(-1)	1.28645e-07
const ap_int<34> rinv_tmp = a2n * delta0;
const ap_int<18> rinv = rinv_tmp >> 16;
//
// STEP 11

// 15 bits 	 2^(-8)Kphi^(1)Kr^(-1)	1.02916e-06
...
// 18 bits 	 2^(0)Kphi^(1)Kr^(0)	7.71867e-06
const ap_int<32> x4_tmp = R6 * delta0;
const ap_int<18> x4 = x4_tmp >> 14;
//
// STEP 6

// 18 bits 	 2^(13)Kphi^(2)Kr^(0)	4.88062e-07
...
const ap_int<35> x6b_tmp = (x6a * 67078);
...
// 18 bits 	 2^(1)Kphi^(1)	1.54373e-05
...
// 17 bits 	 2^(-12)Kphi^(1)Kr^(-1)	6.43223e-08
...
// 18 bits 	 2^(18)Kphi^(2)Kr^(0)	1.5618e-05
...
// 18 bits 	 2^(-15)	3.05176e-05
const ap_int<35> x12A_0_tmp = (x12_0 * 67078);
...
// 18 bits 	 2^(-15)	3.05176e-05
const ap_int<35> x12A_1_tmp = (x12_1 * 67078);
...
// 18 bits 	 2^(-15)	3.05176e-05
const ap_int<35> x12A_2_tmp = (x12_2 * 67078);
...
// 18 bits 	 2^(-15)	3.05176e-05
const ap_int<35> x12A_3_tmp = (x12_3 * 67078);
...
// 17 bits 	 2^(-11)Kphi^(1)Kr^(-1)	1.28645e-07
...
// 11 bits 	 2^(-5)Kphi^(1)Kr^(-1)	8.23325e-06
...
// 18 bits 	 2^(-10)Kphi^(1)Kr^(-1)	2.57289e-07
...
// 18 bits 	 2^(1)Kphi^(1)Kr^(0)Kz^(0)	1.54373e-05
...
// 16 bits 	 2^(3)Kphi^(1)	6.17494e-05
...
// 18 bits 	 2^(20)Kphi^(2)Kr^(0)Kz^(0)	6.24719e-05
...
const ap_int<35> x26A_0_tmp = (x26_0 * 67078);
...
// 18 bits 	 2^(-13)	0.00012207
const ap_int<35> x26A_1_tmp = (x26_1 * 67078);
...
// 18 bits 	 2^(-13)	0.00012207
const ap_int<35> x26A_2_tmp = (x26_2 * 67078);
...
// 18 bits 	 2^(-13)	0.00012207
const ap_int<35> x26A_3_tmp = (x26_3 * 67078);
...
// 18 bits 	 2^(-11)Kphi^(1)Kr^(0)Kz^(-1)	6.43223e-08
const ap_int<33> der_phiD_tmp = x7 * invt;
const ap_int<18> der_phiD = der_phiD_tmp >> 15;
//
// STEP 14

// 10 bits 	 2^(-3)Kphi^(1)Kr^(0)Kz^(-1)	1.64665e-05
